...
var neighborName = 'Summer Smith';
var teacherName = 'Jessica';
...
var japanPrefectures = ['Osaka', 'Kyoto', 'Hokkaido', 'Tokyo', 'Okinawa'];
...
Console log the variable.*/
var india = ['Taj Mahal', 'Darjeeling', 'Khajuraho'];
console.log(india);
...
function contentFiller(obj){
  for (var i=0; i<5; i++){
    obj.push(Math.floor(Math.random()*20));
    console.log(obj);
  }
}
contentFiller(bigBox.contents);
console.log(bigBox);
...
var quote = '.yrt on si ereht ,ton od ro od';
var reverse = '';
...
console.log(firstReverse(quote));
...
console.log(letterCap(reverse));
// var capReverse = letterCap(reverse);
// console.log(capReverse);
...
console.log(longestWord(reverse));